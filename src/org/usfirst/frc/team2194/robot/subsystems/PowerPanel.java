...
public class PowerPanel extends Subsystem {
	...
	public void updateStatus(){
		SmartDashboard.putNumber("Energy Used Joules", getTotalEnergy());
		...
		SmartDashboard.putNumber("Channel 14", getChannelCurrent(14));
		SmartDashboard.putNumber("Channel 15", getChannelCurrent(15));
	}
}
